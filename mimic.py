...
class MimicDataset(Dataset):
    def __init__(self, root, csv_file, transform=None, columns=None, concat_pa=True, use_only_pleural_effusion=True, create_bias=False):
...
if __name__ == "__main__":
    ...
    train_set = MimicDataset(root=data_dir,
                             csv_file=os.path.join(
                                 csv_dir, 'mimic.sample.train.csv'),
                             transform=None,
